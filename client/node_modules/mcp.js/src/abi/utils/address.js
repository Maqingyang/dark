...
function getAddress(address) {
    ...
    if(address.match(/^(0x)[0]{24}?[0-9a-fA-F]{40}$/)) {
        // Convert address to 24 zeros
        address = address.replace(/^0x0{24}/,'0x');
    }
...
/**
 * 
 * @see http://ethereum.stackexchange.com/questions/760/how-is-the-address-of-an-ethereum-contract-computed
 * @param {*} transaction 
 * @returns 
 */
