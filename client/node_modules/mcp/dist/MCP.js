...
var _TransitionWatcher = require('./utils/TransitionWatcher');

var _TransitionWatcher2 = _interopRequireDefault(_TransitionWatcher);

var _MCPHandler = require('./utils/MCPHandler');

var _MCPHandler2 = _interopRequireDefault(_MCPHandler);
...
var MCP = function () {
    ...
    _createClass(MCP, [{
        key: '_changePropsAfterState',
        value: function _changePropsAfterState(s) {
            if (!s) {
                s = this._state;
            }
        ...
        key: 'mcpWhen',
        value: function mcpWhen(actionName, pState, pFromStates) {
        ...
        key: 'mcpFromStates',
        value: function mcpFromStates() {
            if (this._mcpHasErrored) {
                return this;
            }
            var states = Array.prototype.slice.call(arguments);

            this._lastFromStates = (0, _flattenArray2.default)(states);
            return this;
        }
        ...
        key: 'mcpStateIs',
        value: function mcpStateIs(pState) {
            if (this._mcpHasErrored) {
                return this;
            }
            if (!this._lastAction) {
        ...
        key: '_makeAction',
        value: function _makeAction(toState) {
            var _this = this;

            var action = this._lastAction;

            this._ensureAction(action);
            this._actions[action].push(new _MCPHandler2.default((0, _flattenArray2.default)(this._lastFromStates), toState, action));

            // one initialization of an action handles any number of resolved actions.
            if (!this[action]) {
                this[action] = function () {
                    return _this._mcpDo(action);
                };
            }
        }
    }, {
        key: '_ensureAction',
        value: function _ensureAction(action) {
        ...
        value: function _mcpDo(action) {
            ...
            try {
                for (var _iterator = this._actions[action][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: 'mcpWatchState',
        value: function mcpWatchState(state, handler) {
        ...
        key: 'mcpWatchAction',
        value: function mcpWatchAction(action, handler) {
        ...
        key: 'mcpWatch',
        value: function mcpWatch(conditions, handler) {
            var watch = new _TransitionWatcher2.default(this, handler, conditions);
            this._transitionWatchers.push(watch);
            return watch;
        }
    }, {
        key: 'mcpUnwatch',
        value: function mcpUnwatch(watcher) {
            this._transitionWatchers = this._transitionWatchers.filter(function (w) {
                return w !== watcher;
            });
        }
    }, {
        key: 'mcpUnwatchAll',
        value: function mcpUnwatchAll() {
            this._transitionWatchers.forEach(function (w) {
                return w.removed = true;
            });
            this._transitionWatchers = [];
        }
        ...
        key: '_mcpTransitionState',
        value: function _mcpTransitionState(handler, action) {
            var _this2 = this;
            ...
            if (this._transitionWatchers.length) {
                (function () {
                    var event = new _TransitionEvent2.default(handler, action, _this2);
                    _this2._transitionWatchers.forEach(function (watcher) {
                        return watcher.reactTo(event);
                    });
                })();
            }
        ...
        key: '_cantHandleAction',
        value: function _cantHandleAction(action) {
        ...
        key: 'mcpOnState',
        value: function mcpOnState(pState) {
            if (this._mcpHasErrored) {
                return;
            }
        ...
        key: 'mcpPropIs',
        value: function mcpPropIs(pProp, pValue) {
            if (this._mcpHasErrored) {
                return;
            }
            if (!this._onState) {
        ...
        key: 'mcpInitProp',
        value: function mcpInitProp(pProp, pValue) {
            if (this._mcpHasErrored) {
                return this;
            }
            this[pProp] = pValue;
        ...
        key: 'mcpRecoverFromError',
        value: function mcpRecoverFromError() {
            this._mcpHasErrored = false;
            this._lastMCPerror = null;
        }
    }, {
        key: 'mcpReset',
        value: function mcpReset() {
            this._mcpHasErrored = false;
            this._lastMCPerror = null;
            this.mcpState = null;
